...
#according to recent statistics). Fill in the blanks of the max_elevation_city
#function to return the name of the city and its country (separated by a comma),
